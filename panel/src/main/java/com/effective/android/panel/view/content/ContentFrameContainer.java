 ...
 * blog: yummylau.com
 */
public class ContentFrameContainer extends FrameLayout implements IContentContainer {
    ...
    public ContentFrameContainer(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ContentFrameContainer(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(attrs, defStyleAttr, 0);
    }

    @TargetApi(21)
    public ContentFrameContainer(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
