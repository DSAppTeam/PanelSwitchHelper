 ...
 * version: 1.0
 */
class FixIssuesActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun start(context: Context?) {
            ...
            val intent = Intent(context, FixIssuesActivity::class.java)
                        ...
                        if (panelView is PanelView) {
                            when (panelView.id) {
                                R.id.panel_emotion -> {
                                    ...
                                    val viewPagerSize = height - DisplayUtils.dip2px(this@FixIssuesActivity, 30f)
